    ...
    <section className="min-h-screen bg-cream py-20">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="mb-12 text-center">
          <p className="text-sm uppercase tracking-[0.3em] text-brand-500">Collections</p>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          {collections.map((collection) => (
            <article key={collection.title} className="glass-card p-8">
              <p className="text-sm uppercase tracking-[0.28em] text-brand-600">Collection</p>
              ...
              <Link
                href="/shop"
                className="mt-8 inline-flex rounded-full border border-brand-200 bg-brand-50 px-5 py-3 text-sm font-semibold text-brand-700 transition hover:bg-brand-100"
              >
                Découvrir
              </Link>
            </article>
